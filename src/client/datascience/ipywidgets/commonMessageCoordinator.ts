...
export class CommonMessageCoordinator {
    ...
    private getIPyWidgetScriptSource() {
        if (!this.ipyWidgetScriptSource) {
            ...
            this.disposables.push(this.ipyWidgetScriptSource.postMessage(this.cacheOrSend.bind(this.postEmitter)));
            this.disposables.push(
                this.ipyWidgetScriptSource.postInternalMessage(this.cacheOrSend.bind(this.postEmitter))
            );
        }
