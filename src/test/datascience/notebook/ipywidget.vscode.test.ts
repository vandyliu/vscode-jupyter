...
import { VSCodeNotebookController } from '../../../client/datascience/notebook/notebookExecutionHandler';
...
suite('DataScience - VSCode Notebook - IPyWidget test', () => {
    ...
    function flagForWebviewLoad(flag: Deferred<boolean>, targetDoc: NotebookDocument) {
        const commsList = VSCodeNotebookController.Communications.get(targetDoc) || [];
